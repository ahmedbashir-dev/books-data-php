                ...
                <?php
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if(empty($errors)){
                            ...
                            $dbc = db_connect();
                            $sql = "INSERT INTO books VALUES (NULL,'$title','$author','$price','$target_file')";
                            $result = mysqli_query($dbc,$sql);
                            if(!$result){
                                echo "<div class = 'alert alert-danger'> Cannot Add Book: " . mysqli_error($dbc) . "</div>";
                            }
                            else{
                                echo "<div class = 'alert alert-success'>Book Added Successfully. 
